//Purpose: test 4 DS18B20 digital hot water sensors
//Connection:
...
//4. RealTime clock---AndrewH
//link
//5. LCD---AndrewS
//link
//6. SD card--- Ken, Justin
//link 
//Gunn InveTeam Copy Right

#include <OneWire.h> 

//solar water heater test plan
//T1 for outdoor temp
...
OneWire ds3(DS18B20_Pin3); //T1 on digital pin2
OneWire ds4(DS18B20_Pin4); //T2 on digital pin3
...
void loop(void) {
  ...
  //SD save realtime and 4 temperature---Ken, Justin
